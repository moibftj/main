...
### Tech Stack
- Next.js 16 App Router (TypeScript, SSR, Server Actions)
- Supabase (Auth, PostgreSQL, RLS)
- Stripe for payments/subscriptions
- Google Gemini AI for letter generation (via `/api/generate-letter`)
...
### Review List Page
**Route:** `/app/secure-admin-gateway/review/page.tsx`
...
### Review Detail Page
**Route:** `/app/secure-admin-gateway/review/[id]/page.tsx`
...
**Actions:**
- **Approve** → Update status to approved, commit final text
